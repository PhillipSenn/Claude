...
<div class="sticky-top">
	<div class="progress" style="height:1.25rem;border-radius:0;">
		<div class="progress-bar" id="scroll-progress" role="progressbar" style="width:0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
	</div>
</div>
...
<a class="nav-link active">Art Institute of Chicago</a>
