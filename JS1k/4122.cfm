...
setInterval(gameTick, 22)
				...
				<div class="tab-pane fade" id="tab-commented" role="tabpanel" style="height:100%; overflow:hidden;">
					<div style="display:flex; flex-direction:column; height:100%;">
						...
						<div id="src-commented" class="p-3" style="flex:1; overflow:auto; min-height:0; font-family:monospace; font-size:20px; white-space:pre-wrap;">
<div class="text-muted">/*
JS1K 2019 #4122 - PAC-MAN by feiss
...
function getExecutableCode(sourceId) {
	...
	if (sourceId === 'src-commented') {
		// Clone the element, remove all text-muted children, return remaining text
