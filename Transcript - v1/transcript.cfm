...
<div class="row">
	<div class="col-xl-4">
		<div class="card">
			<div class="card-header bg-success-subtle">Transcript</div>
			<div class="card-body">
<p>With the school year ending, all over the country educators and parents are taking stock of the drastic shift caused by artficial intelligence in the classroom.</p>
<p>Today, Natasha Singer, a technology reporter, discusses the year that reshaped American classrooms and how one dedicated teacher helped his students chart their own path into an uncertain future.</p>
...
<p>This teacher in Newark developed chatbots for his U.S. history classes to help his students hone their argumentative writing.Credit...Juan Arredondo for The New York Times</p>
	...
	<div class="col-xl-4 ps-0">
		<div class="card">
			<div class="card-header bg-primary-subtle">John</div>
			<div class="card-body">
	...
	<div class="col-xl-4 ps-0">
		<div class="card">
			<div class="card-header bg-info-subtle">Classroom responses</div>
			<div class="card-body">
				<table id="responses">
					<thead>
						<tr>
...
<a class="nav-link" href="#request.script_name#">Transcript</a>
